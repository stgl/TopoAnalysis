...
for prefix in prefixes:
    ...
    ksi = d.Ksi.load(prefix + '_ksi_250000_0_6')
    relief = d.ScaledRelief.load(prefix + '_relief_250000_0_6')
    
    fig = plt.figure()
    ksi_vec, relief_vec = plotGrids(ksi, relief, 'k.', rasterized = True)
    plt.savefig(prefix + '0_6.png',dpi=600)
    plt.close()
...
plt.savefig('all_0_6.png',dpi=600)
